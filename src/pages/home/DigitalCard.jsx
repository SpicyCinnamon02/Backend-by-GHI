...
const DigitalCard = () => {
    return (
        <div
            className="h-[400px] lg:h-[70vh] py-[80px] sm:pt-[100px] sm:pb-[80px] bg-fill lg:bg-cover lg:bg-center bg-no-repeat flex justify-center items-center lg:items-start flex-col gap-10 lg:gap-5"
